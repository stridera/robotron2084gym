...
player_collision_detection EQU $9848           ; When set to 1, it means player collision detection routine is checking for collisions.
...
1263: 8B F0       ADDA  #$F0                 ; add #$F0  (-15 decimal) (Results in -16 to 15)
...
126B: 84 3F       ANDA  #$3F
126D: 8B E0       ADDA  #$E0                 ; results in -32 to 31
...
1292: 43          COMA                       ; 2 Compliment A
1293: 53          COMB                       ; 2 compliment B
1294: 58          ASLB                       ; Left shift B (Doubles value)
1295: 49          ROLA                       ; Rotate left through carry
1296: 58          ASLB  
1297: 49          ROLA  
1298: 1F 89       TFR   A,B
129A: 1D          SEX   
