...
class Electrode(Base):
    ...
    def get_animations(self):
        ...
        animation_levels = [
            self.engine.get_sprites(['electrode1', 'electrode2', 'electrode3']),  # 1, 11, 21, etc
            self.engine.get_sprites(['electrode4', 'electrode5', 'electrode6']),  # 2
            self.engine.get_sprites(['electrode7', 'electrode8', 'electrode9']),  # 3
            self.engine.get_sprites(['electrode10', 'electrode11', 'electrode12']),  # 4
            self.engine.get_sprites(['electrode13', 'electrode14', 'electrode15']),  # 5
            self.engine.get_sprites(['electrode16', 'electrode17', 'electrode18']),  # 6
            [],  # 7
            self.engine.get_sprites(['electrode25', 'electrode26', 'electrode27']),  # 8
            [],  # 9
            self.engine.get_sprites(['electrode19', 'electrode20', 'electrode21']),  # 10, 20, ect
        ]
